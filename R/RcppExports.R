...
glm_ridge_c <- function(x, pseudo_obs, lambda, intercept, thresh, qa_updates_max) {
    .Call('glmproj_glm_ridge_c', PACKAGE = 'glmproj', x, pseudo_obs, lambda, intercept, thresh, qa_updates_max)
}
