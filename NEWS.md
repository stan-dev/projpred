...
* Global option `projpred.prll_cv` has been deprecated. Please use global option `projpred.parallel_cv` instead (or directly `cv_varsel()`'s argument `parallel`). (GitHub: #500, #521)
