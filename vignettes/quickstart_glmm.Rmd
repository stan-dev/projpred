...
# We'll use `nclusters_pred = 20` here in this vignette only for the sake of
# speed. This is not recommended in general.
vs <- varsel(ref, nclusters_pred = 20)
```
...
# We'll use `nclusters = 20` here in this vignette only for the sake of
# speed. This is not recommended in general.
proj <- project(vs, nterms = 2, nclusters = 20)
...
# We'll use `nclusters_pred = 20` here in this vignette only for the sake of
# speed. This is not recommended in general.
vs <- varsel(fit, nclusters_pred = 20)
```
...
# We'll use `nclusters_pred = 20` here in this vignette only for the sake of
# speed. This is not recommended in general.
vs_va <- varsel(fit_va, nclusters_pred = 20)
```
...
# We'll use `nclusters_pred = 20` here in this vignette only for the sake of
# speed. This is not recommended in general.
cv_vs_va <- cv_varsel(fit_va, validate_search = FALSE, nclusters_pred = 20)
```
