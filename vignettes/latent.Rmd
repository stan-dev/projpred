...
Note that a forward search would have given slightly different results (in particular, a slightly smoother submodel size selection plot). However, for speeding up the building of this vignette, we use L1 search here.
