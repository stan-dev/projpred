...
Only now, after we have made a decision for the submodel size, we inspect further results from the variable selection and, in particular, the predictor ranking (also known as solution path):
```{r smmry_vsel_lat}
smmry_lat <- summary(
  vs_lat,
  stats = "mlpd",
...
Only now, after we have made a decision for the submodel size, we inspect further results from the variable selection and, in particular, the predictor ranking:
```{r smmry_vsel_nebin}
smmry_nebin <- summary(
  vs_nebin,
  stats = "mlpd",
