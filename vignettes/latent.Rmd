...
smmry_trad <- summary(vs_trad, stats = "gmpd",
                      type = c("mean", "lower", "upper", "diff"))
...
Although the submodels' GMPDs approach the reference model's already from a submodel size of 9 on (taking into account the uncertainty bars), the curve levels off only from a submodel size of 11 on.
...
```{r smmry_vsel_nebin}
smmry_nebin <- summary(vs_nebin, stats = "gmpd",
                       type = c("mean", "lower", "upper", "diff"))
