...
As the curve levels off only from a submodel size of 11 on, we will decide for a submodel size of 11 (in other words, we act as if we preferred accuracy over sparsity in their trade-off mentioned in the [main vignette](https://mc-stan.org/projpred/articles/projpred.html)):
```{r size_man_nebin}
