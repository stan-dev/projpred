...
# We'll use small values for `nterms_max`, `nclusters` and `nclusters_pred` here
# and later in this vignette only to speed up the building of this vignette.
# This is not recommended in general.
vs <- cv_varsel(refmodel, method = "forward",
                nterms_max = 10, nclusters = 5, nclusters_pred = 10)
```
...
proj <- project(vs, nterms = 3, nclusters = 10)
