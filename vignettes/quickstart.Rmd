...
For a simple linear model, the fastest method is to use L1--search, that is the default option. For a more accurate result we recommend running forward search.
