...
Plot the cross-validated performance estimates on the absolute scale. In this case the cross-validated results differ from the training statistics especially for model sizes 3 to 7 varibles. About 7 variables gives predictive accurary similar to the full model.
```{r}
# model size suggested by the program
fit_cv$varsel$ssize
```
