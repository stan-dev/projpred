...
The projection predictive variable selection is based on the ideas of @goutis_model_1998 and @dupuis_variable_2003. The methods implemented in **projpred** are described in detail in @piironen_projective_2020, @catalina_projection_2020, and (**TODO (augdat)**: Add reference for the augmented-data projection here.). They are evaluated in comparison to many other methods in @piironen_comparison_2017. Type `citation("projpred")` for details on how to cite **projpred**.
