...
In the following and throughout **projpred**'s documentation, the term "traditional projection" is used whenever the projection type is not the augmented-data projection (see below for a description of the augmented-data projection).
