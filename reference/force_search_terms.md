...
[`cv_varsel()`](https://mc-stan.org/projpred/reference/cv_varsel.md) if
certain predictor terms should be forced to be selected first whereas
...
of [`varsel()`](https://mc-stan.org/projpred/reference/varsel.md) or
