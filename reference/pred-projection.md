...
returned by a
[`project()`](https://mc-stan.org/projpred/reference/project.md) call to
an object of class `vsel`; see
[`project()`](https://mc-stan.org/projpred/reference/project.md)).
...
- object:
  ...
  [`project()`](https://mc-stan.org/projpred/reference/project.md) or an
  object that can be passed to argument `object` of
  [`project()`](https://mc-stan.org/projpred/reference/project.md).
...
- filter_nterms:
  ...
  [`project()`](https://mc-stan.org/projpred/reference/project.md). In
  that case, `filter_nterms` can be used to filter `object` for only
...
- .seed:
  ...
  called internally with `seed = NA` (or with `seed` being a lazily
...
- ...:
  ...
  Arguments passed to
  [`project()`](https://mc-stan.org/projpred/reference/project.md) if
  `object` is not already an object returned by
  [`project()`](https://mc-stan.org/projpred/reference/project.md).
...
[refmodel-init-get](https://mc-stan.org/projpred/reference/refmodel-init-get.md)
...
- `proj_linpred()` returns a `list` with the following elements:
  ...
  [`init_refmodel()`](https://mc-stan.org/projpred/reference/refmodel-init-get.md);
  see also
  [`extend_family()`](https://mc-stan.org/projpred/reference/extend_family.md)'s
