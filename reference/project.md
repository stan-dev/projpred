...
[`cv_varsel()`](https://mc-stan.org/projpred/reference/cv_varsel.md) use
`nclusters = 20`). Consequently, `project()` with `refit_prj = FALSE`
then inherits this coarse clustering or thinning.
