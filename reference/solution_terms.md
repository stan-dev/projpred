# Retrieve the full-data solution path from a [`varsel()`](https://mc-stan.org/projpred/reference/varsel.md) or [`cv_varsel()`](https://mc-stan.org/projpred/reference/cv_varsel.md) run or the predictor combination from a [`project()`](https://mc-stan.org/projpred/reference/project.md) run
...
[`ranking()`](https://mc-stan.org/projpred/reference/ranking.md) instead
of `solution_terms.vsel()`
