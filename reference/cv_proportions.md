...
- object:
  ...
  by [`ranking()`](https://mc-stan.org/projpred/reference/ranking.md)).
  ...
  that [`ranking()`](https://mc-stan.org/projpred/reference/ranking.md)
...
[`ranking()`](https://mc-stan.org/projpred/reference/ranking.md) call.
The rows correspond to the submodel sizes and the columns to the
...
created by
[`varsel()`](https://mc-stan.org/projpred/reference/varsel.md) or by
[`cv_varsel()`](https://mc-stan.org/projpred/reference/cv_varsel.md),
