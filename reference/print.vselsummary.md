# Print summary of a [`varsel()`](https://mc-stan.org/projpred/reference/varsel.md) or [`cv_varsel()`](https://mc-stan.org/projpred/reference/cv_varsel.md) run
...
use the [`ranking()`](https://mc-stan.org/projpred/reference/ranking.md)
