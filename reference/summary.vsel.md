# Summary of a [`varsel()`](https://mc-stan.org/projpred/reference/varsel.md) or [`cv_varsel()`](https://mc-stan.org/projpred/reference/cv_varsel.md) run
...
- stats:
  ...
  `d_test = NULL`, these are again all observations because the test set
  is the same as the training set). Available statistics are:
