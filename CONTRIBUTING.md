...
This outlines how to propose a change to projpred and is based on
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("stan-dev/projpred", fork = TRUE)`.
...
Please note that the projpred project follows the Stan project’s [Code
of
